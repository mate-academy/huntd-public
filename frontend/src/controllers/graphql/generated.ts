...
export type Post = {
  ...
  description: Maybe<Scalars["String"]>;
  recruiter?: Maybe<RecruiterProfile>;
};
...
export type RecruiterProfileFullFragment = {
  ...
  RecruiterPostFragment;

export type RecruiterProfileUserFragment = {
  __typename?: "RecruiterProfile";
} & { user?: Maybe<{ __typename?: "User" } & UserBaseFragment> };

export type RecruiterPostFragment = {
  __typename?: "[Post]";
} & { posts?: Maybe<Array<{ __typename?: "Post" } & PostFragment>> };
...
export const RecruiterProfileUserFragmentDoc = /*#__PURE__*/ gql`
  ...
  ${UserBaseFragmentDoc}
`;
export const RecruiterPostsFragmentDoc = /*#__PURE__*/ gql`
  fragment RecruiterProfilePosts on RecruiterProfile {
    posts {
      ...PostCreate
    }
  }
...
export const RecruiterProfileFullFragmentDoc = /*#__PURE__*/ gql`
  fragment RecruiterProfileFull on RecruiterProfile {
    ...
    ...RecruiterProfilePosts
  }
  ${RecruiterProfileBaseFragmentDoc}
  ${RecruiterProfileUserFragmentDoc}
  ${RecruiterPostsFragmentDoc}
`;
